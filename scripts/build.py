...
def home():
    ...
    for i,stat in enumerate(stats):
        ...
        h+='<div class="number-card number-card-'+str(i)+'"><span class="card-spark" aria-hidden="true"></span><strong aria-label="'+number+'"><span class="count-number" data-count="'+match[1]+'" aria-hidden="true">'+match[1]+'</span><span class="count-suffix" aria-hidden="true">'+match[2]+'</span></strong><span class="number-label">'+content(stat.one(cls='lbl'))+'</span></div>'
